    ...
    <div className="max-w-4xl mx-auto py-12 px-6">
      ...
      <div className="mt-12 text-center">
        <p className="text-xs text-slate-400 font-medium max-w-lg mx-auto italic">
          Architect-built courses feature serialized units, automated technical audits, and high-density 4000-word instructional manuals grounded in Tallman ERP and DDIN specifications.
        </p>
      </div>
    </div>
  );
